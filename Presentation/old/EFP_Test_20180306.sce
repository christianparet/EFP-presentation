pcl_file = "EFP_Test_20180424.pcl";
...
bitmap { filename = "arrow_up.png"; alpha = -1; preload = true;} arrow_up;
...
###               Feedback              ###
###########################################
# Elements used for end-of-block feedback with chart as well as thermometer
...
text { caption = "Mit unterer Taste bestätigen."; } bestaetigen;
