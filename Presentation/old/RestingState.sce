...
term.print("Anleitung vorlesen:\nBitte halten Sie die Augen geöffnet und betrachten Sie das Kreuz, das in der Mitte des Bildschirms erscheint. Sie müssen nichts weiter tun. Der Ruhe-Scan dauert 6 min.\n\nJetzt Scanner starten.\n\n");
